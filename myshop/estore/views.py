...
def index(request):
    ...
    return render(request, 'estore/index.html', info)
...
def empty(request):
    return render(request, 'estore/empty.html')


def emptycart(request):
    return render(request, 'estore/emptycart.html')
...
class Base(View):
    ...
    def get(self, request):
        ...
        return render(request, 'estore/product.html', data)
        # print(pdt)
...
class Cart(View):
    def get(self,request):
        if request.session.get('cart'):
            ...
            print(products)
            return render(request, 'estore/cart.html', {'products': products})
        else:
            return render(request,'estore/emptycart.html')
...
def order(request):
    return render(request, 'estore/order_placed.html')
...
class CheckOut(View):
    def get(self, request):
        if request.session.get('cart'):
            ...
            products = Product.get_products_by_id(ids)
            print(products)
            return render(request, 'estore/checkout.html', {'products': products})
...
class Order(View):
    def get(self, request):
        ...
        print(order)
        return render(request, 'estore/order_placed.html', {'order': order})
